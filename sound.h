...
public:
	...
	__forceinline void GetActiveSounds(CUtlVector< SoundInfo >& sndlist) {
		return util::get_method< void(__thiscall*)(void*, CUtlVector< SoundInfo >&) >(this, GETACTIVESOUNDS)(this, sndlist);
	}
};